...
namespace Web.Entity.Repository.Generic
{
    public class GenericRepositoryAsync<T> : IRepositoryAsync<T> where T : class, IBaseEntity
    {
        ...
        public virtual async Task<T> Update(Guid id, T updatedEntity, bool updateCreateTime = false, bool updateUpdatedTime = true)
        {
